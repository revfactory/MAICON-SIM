...
이 저장소는 하네스 강의 현장에서 요구사항을 받아 그 자리에서 만들어진 결과물이다. 출발점은 대회에서 쓰인 트랙 사진 한 장과 다음 한 줄이었다.
...
| 파일 | 무엇을 검증했나 |
|------|----------------|
| `topdown_compare.png` / `topdown_v2.png` | 도면과 1:1 대조용 직교 톱다운 (2000×1400, 도면과 동일 해상도) |
